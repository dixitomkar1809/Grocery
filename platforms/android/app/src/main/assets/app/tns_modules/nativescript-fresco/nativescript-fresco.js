...
function initializeAnimatedImage() {
    if (exports.AnimatedImage) {
        return;
    }
    var AnimatedImageImpl = (function (_super) {
        __extends(AnimatedImageImpl, _super);
        function AnimatedImageImpl() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        AnimatedImageImpl.prototype.start = function () {
            _super.prototype.start.call(this);
        };
        AnimatedImageImpl.prototype.stop = function () {
            _super.prototype.stop.call(this);
        };
        AnimatedImageImpl.prototype.isRunning = function () {
            return _super.prototype.isRunning.call(this);
        };
        return AnimatedImageImpl;
    }(com.facebook.imagepipeline.animated.base.AnimatedDrawable));
    exports.AnimatedImage = AnimatedImageImpl;
}
